 ...
 */
public class wCrawler extends CommonCrawler {
    ...
    public FashionModel GetPicture(String url) throws IOException{
        ...
        String magazine = "WMagazine";
        String imageurl = webPage.select("div.edits div.largecovers img").first().attr("abs:src").trim().toString();
    ...
    public void Main(String[] args){
        String url = "https://subscribe.wmagazine.com/subscribe/wmagazine/105017";
